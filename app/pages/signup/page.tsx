...
const RegisterPage: React.FC = () => {
            ...
            try {
                ...
                if (data && Array.isArray(data)) {
                    const formattedCountries = data.map((c) => ({
                        label: c.countryName,
                        value: c.countryName,
                        code: c.countryCode // Storing code just in case, but value holds the name
                    }));
    ...
    useEffect(() => {
        const fetchCities = async () => {
            ...
            try {
                // formData.country holds the full country name
    ...
    function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
        ...
        (async function () {
            try {
                // REVERTED: Send formData directly (which contains countryName) and combine the phone number
                const apiPayload = {
                    ...formData,
