                ...
                <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-5 justify-center items-center">
                    ...
                    <Link href="/pages/signup" passHref legacyBehavior>
                        <motion.a 
                            ...
                            className="group relative w-full sm:w-auto px-10 py-4 bg-appNav rounded-full text-white font-bold text-lg shadow-[0_0_20px_rgba(59,130,246,0.4)] hover:shadow-[0_0_40px_rgba(59,130,246,0.6)] border border-blue-400/30 overflow-hidden cursor-pointer"
                        >
                            {/* Shimmer Effect */}
                    ...
                    <Link href="/pages/how-it-works" passHref legacyBehavior>
                        <motion.a 
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="w-full sm:w-auto px-10 py-4 bg-transparent border-2 border-white/50 rounded-full text-white font-bold text-lg backdrop-blur-md transition-colors cursor-pointer text-center"
                        >
                            Learn How It Works
                        </motion.a>
                    </Link>
