...
interface BusinessRegSuccessProps {
    onClose: () => void;
}

const BusinessRegSuccess = ({ onClose }: BusinessRegSuccessProps) => {
    return (
        <div className="flex flex-col p-6 text-white">
            <div className="flex flex-col items-center justify-center p-2 text-white">
                ...
                <h2 className="text-2xl font-bold mb-2">Business Registration Submitted Successfully!</h2>
            ...
            <div className="space-y-10 flex flex-col items-center justify-start w-full h-auto p-4">
                <div className="flex flex-row w-full items-center justify-start gap-6">
                    ...
                    <div className="flex flex-col w-full">
                        ...
                        <p className="font-semibold text-white">Our team will verify your business information and documents. This process typically takes 2-3 business days.</p>
                    </div>
                </div>
                ...
                <div className="flex flex-row w-full items-center justify-start gap-6">
                    ...
                    <div className="flex flex-col w-full">
                        <h5 className="font-bold text-white">Verification Process</h5>
                        <p className="font-semibold text-white">We'll verify your business registration, tax information, and other submitted documents.</p>
                    </div>
                </div>
                ...
                <div className="flex flex-row w-full items-center justify-start gap-6">
                    ...
                    <div className="flex flex-col w-full">
                        <h5 className="font-bold text-white">Account Setup</h5>
                        <p className="font-semibold text-white">Once approved, we'll set up your business account and provide access to our platform.</p>
                    </div>
                </div>
                ...
                <div className="flex flex-row w-full items-center justify-start gap-6">
                    ...
                    <div className="flex flex-col w-full">
                        ...
                        <p className="font-semibold text-white">We'll guide you through the platform features and help you get started with your logistics operations.</p>
                    </div>
                </div>
            </div>

            <div className="flex items-center w-full mt-8">
                <h6 className="text-white">The entire process takes 5-7 business days. We'll keep you updated at every step.</h6>
            </div>
...
export default BusinessRegSuccess;